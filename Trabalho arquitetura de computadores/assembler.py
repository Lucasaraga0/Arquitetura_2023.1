...
instructions = ['addx', 'subx', 'goto', 'movx', 'jzx', 'halt', 'wb', 'ww', 'jzy' , 'addy', 'suby' , 'movy', 'mul']
...
def encode_instruction(inst, ops):
   if inst == 'addx' or inst == 'subx' or inst == 'movx' or inst == 'jzx' or inst == 'jzy' or inst == 'movy' or inst == 'addy' or inst == 'suby' or inst =='mul' :
...
def resolve_names():
   ...
   for line in lines_bin:
      for i in range(0, len(line)):
         if is_name(line[i]):
            if line[i-1] == instruction_set['addx'] or line[i-1] == instruction_set['subx'] or line[i-1] == instruction_set['movx']  or  line[i-1] == instruction_set['addy'] or line[i-1] == instruction_set['suby'] or line[i-1] == instruction_set['movy'] or line[i-1] == instruction_set['mul']:
